class Solution:
    def uncommonFromSentences(self, s1: str, s2: str) -> list[str]:
        ...
        for tmp_s1 in split_s1:
            print(tmp_s1, split_s1.count(tmp_s1), tmp_s1 in split_s2)
            if split_s1.count(tmp_s1) > 1 or tmp_s1 in split_s2:
                continue
            result.append(tmp_s1)
        for tmp_s2 in split_s2:
            print(tmp_s2, split_s2.count(tmp_s2), tmp_s2 in split_s1)
...
y = Solution()
print(y.uncommonFromSentences("apple apple", "banana"))
